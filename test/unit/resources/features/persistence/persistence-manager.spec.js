...
describe('PersistenceManager', function () {
  ...
  describe('.registerEntity()', function () {
    it('Should register an entity in the manager', function() {
      sut.registerEntity(BaseEntity);
      expect(sut.entities).toEqual({'baseentity': BaseEntity});
    });

    it('Should throw an error when registering with a non-Entity', function() {
      expect(function () {
        sut.registerEntity({});
  ...
  describe('.getEntityManager()', function () {
    ...
    it('Should create default entity manager for string.', function () {
  ...
  describe('.resolveEntityReference()', function () {
    it(`Should register and resolve to an entity itself.`, function() {
      expect(sut.resolveEntityReference(Entity) === Entity).toBe(true);
    });

    it(`Should resolve to the default entity reference 'Entity' on any string.`, function() {
